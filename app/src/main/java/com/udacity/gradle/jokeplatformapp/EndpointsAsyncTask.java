...
import gradle.udacity.com.jokeplatformbackendlib.backend.myApi.MyApi;

/**
 * Created by andermaco on 18/12/15.
 */
public class EndpointsAsyncTask extends AsyncTask<Void, Void, String> {
    ...
    public EndpointsAsyncTask(OnEndpointsAsyncTaskListener onEndpointsAsyncTaskListener) {
        ...
        protected void onPostExecute(String result) {
           onEndpointsAsyncTaskListener.onEndPointAction(result);
        }

        public interface OnEndpointsAsyncTaskListener {
            void onEndPointAction(String result);
        }
